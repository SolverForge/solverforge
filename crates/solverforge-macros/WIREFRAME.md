...
| `generate_list_operations` | `fn(&Fields) -> TokenStream` | Generates owner-specific list helper families from the entity-side list metadata and `ListVariableEntity` bridge |
