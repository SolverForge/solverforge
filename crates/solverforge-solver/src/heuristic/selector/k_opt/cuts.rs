...
impl CutCombinationIterator {
    pub(crate) fn new(k: usize, len: usize, min_seg: usize, entity_idx: usize) -> Self {
...
pub(crate) fn count_cut_combinations(k: usize, len: usize, min_seg: usize) -> usize {
