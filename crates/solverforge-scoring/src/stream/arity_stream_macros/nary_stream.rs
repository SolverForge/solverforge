// Unified N-ary constraint stream macros for tri/quad/penta arities.
//
// Tri/quad/penta streams share identical structure — only filter trait names,
// entity ref counts in closures, and weight signatures differ. All three macros
