...
impl<S, M> ConstructionForagerImpl<S, M> {
    ...
    pub fn from_config(config: ConstructionHeuristicType) -> Self {
        match config {
            ...
            ConstructionHeuristicType::CheapestInsertion => Self::best_fit(),
            ConstructionHeuristicType::AllocateEntityFromQueue => Self::best_fit(),
            ConstructionHeuristicType::AllocateToValueFromQueue => Self::best_fit(),
        }
    }
